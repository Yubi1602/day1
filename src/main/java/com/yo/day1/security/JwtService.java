...
//    private CurrentUserResponse me
    ...
    public List<String> extractRoles(String token){
        ...
        Object roblesObject = claims.get("roles");
        if (roblesObject instanceof List<?> roleList){
    ...
    public Instant extractExpirations(String token){
